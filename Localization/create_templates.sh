...
radii=( "17.5" "14.0" "16.0" "11.5" "10.0" "9.5" "9.0" "8.5" "8.0" "7.5" "5.5" "5.0" "4.0" )
...
for i in "${!files[@]}"; do
	...
	create_template.py -f pdbs/${files[i]} -d templates -o ${pdb}_${boxsize[i]}px_${px}A_${defocus}um.mrc -s 1.25 -b 8 --modify_structure --solvent_correction gaussian -c -z ${defocus} -v ${voltage} -l 20 -x ${boxsize[i]} --gpuID 4
done
